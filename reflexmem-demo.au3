  ...
  While 1
    Switch GUIGetMsg()
      ...
      Case $idCreate
        ...
        ExitLoop
      Case $idPlugin
        MsgBox(64, "ReflexMem Demo", "You are running ReflexMem Demo which is free and doesn't have the ability to import or run plugins. Please go to www.reflexmem.com and buy the Elite version of ReflexMem. In the meantime, thanks for using ReflexMem Demo!")
        ImportFileToInclude()
      Case $idAbout
        MsgBox(64, "About ReflexMem Demo 1.0", "ReflexMem is an attempt to create non-coding trigger-based automation on Windows. It was created by ReflexMem Industrries LLC and the demo is free to use. If you have feedback about this product or find this software useful please contact us at reflexmem@gmail.com.")
      Case Else
